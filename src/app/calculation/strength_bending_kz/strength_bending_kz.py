...
# print(os.getcwd())
# print('============')
with open(os.path.dirname(os.path.abspath(__file__))+'../../../../reference_data/concrete_data.json', "r", encoding="utf-8") as data_c:
    concrete_data = json.load(data_c)

with open(os.path.dirname(os.path.abspath(__file__))+'../../../../reference_data/reinforcement_data.json', "r", encoding="utf-8") as data_r:
    reinforcement_data = json.load(data_r)


# concrete_data = {"B20": [11500],
#                  "B25": [14500],
#                  "B30": [17000]}
# reinforcement_data = {"A400": [365000, 365000],
#                       "A500": [435000, 435000],
#                       }
...
def strength_bending_kz(input_data):
